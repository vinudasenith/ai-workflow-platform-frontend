                                    ...
                                    {workflows.map((wf) => (
                                        <tr key={wf.id}>
                                            ...
                                            <td className="px-6 py-4 text-center ">
                                                <button
                                                    onClick={() => navigate(`/dashboard/${wf.tenantId}/staff/taskManagment/operations/tasks`)}
                                                    className="px-3 py-1 bg-green-500 hover:bg-green-600 text-white rounded font-medium text-sm mr-1 "
                                                >
                                                    View Tasks
                                                </button>
                                                <button
