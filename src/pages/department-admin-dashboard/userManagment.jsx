...
export default function UserManagment() {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            setUsers(res.data); ("/user/tenant/all");
            setUsers(res.data);
        } catch (err) {
        ...
        <div className="bg-gray-50 min-h-screen p-8">
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-500 mt-2">Manage all staff and users within your department</p>
                </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {users.map((user) => {
                                        // Compute status text
                                        let statusText = user.approved ? "Approved" : user.status === "Declined" ? "Declined" : "Pending";
                                        ...
                                        return (
                                            <tr key={user.email}>
                                                ...
                                                <td className="px-6 py-4 text-center space-x-2">
                                                    {/* Always show Approve and Decline buttons */}
                                                    <button
